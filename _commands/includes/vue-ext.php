...
if($command_options[0] == 'vue-ext' && $command_options[1] == 'pullcore-third-front'){
  echo "Hola 3";
}

if($command_options[0] == 'vue-ext' && $command_options[1] == 'pullpush-third-front'){
  $project = ROOT.'/'.$command_options[2].'/src/modules';
  ppdev($project);
  sendCommand($option_one);
}

if($command_options[0] == 'vue-ext' && $command_options[1] == 'publish-third-front'){
  $folder = ROOT.'/'.$command_options[2];
  ...
  // $publish_folder = $project.'/_core/publish';
  // $system_folder = $publish_folder.'/system';
  // $file_zip = $publish_folder.'/dist.zip';
  // $folder_target = ROOT.'/'.$command_options[2].'/dist';
